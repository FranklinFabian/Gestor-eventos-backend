  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const frontendRoutes: CasbinValue = {
      ...
      '/admin/categorias': {
        [RolEnum.ADMINISTRADOR]: 'read|update|create',
        [RolEnum.ORGANIZADOR]: 'read',
        [RolEnum.EXPOSITOR]: 'read',
      },

      '/admin/eventos': {
        [RolEnum.ADMINISTRADOR]: 'read|update|create',
        [RolEnum.ORGANIZADOR]: 'read|update|create',
        [RolEnum.EXPOSITOR]: 'read',
    ...
    const backendRoutes: CasbinValue = {
      ...
      '/api/eventos/:id/activacion': {
        [RolEnum.ADMINISTRADOR]: 'PATCH',
      },

      '/api/eventos/:id/inactivacion': {
        [RolEnum.ADMINISTRADOR]: 'PATCH',
      },
      ...
      '/api/categorias/:id/activacion': {
        [RolEnum.ADMINISTRADOR]: 'PATCH',
      },

      '/api/categorias/:id/inactivacion': {
        [RolEnum.ADMINISTRADOR]: 'PATCH',
      },
      ...
      '/api/participantes/:id/activacion': {
        [RolEnum.ADMINISTRADOR]: 'PATCH',
      },

      '/api/participantes/:id/inactivacion': {
        [RolEnum.ADMINISTRADOR]: 'PATCH',
      },

      '/api/participantes/:grupo/listado': {
        [RolEnum.TODOS]: 'GET',
      },
    }
